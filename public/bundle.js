...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/BoardStyle.css":
/*!******************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/BoardStyle.css ***!
  \******************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js!./BoardStyle.css */ "./node_modules/css-loader/dist/cjs.js!./src/BoardStyle.css");
...
/* harmony import */ var _BoardStyle_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BoardStyle.css */ "./src/BoardStyle.css");
/* harmony import */ var _BoardStyle_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_BoardStyle_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _reverciScript__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reverciScript */ "./src/reverciScript.js");
/* harmony import */ var _reverciScript__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_reverciScript__WEBPACK_IMPORTED_MODULE_1__);



/***/ }),

/***/ "./src/reverciScript.js":
/*!******************************!*\
  !*** ./src/reverciScript.js ***!
  \******************************/
/*! no static exports found */
...
var VISUAL_BOARD = document.getElementsByClassName("board")[0];
var VISUAL_CELL_ARRAY = document.querySelectorAll(".cell");
var H2_Now_PLAYING = document.getElementsByTagName("h2")[0];
var SPAN_NUM_OF_BLACK_PIECES = document.getElementById("BlackPieces").getElementsByTagName("span")[0];
var SPAN_NUM_OF_WHITE_PIECES = document.getElementById("WhitePieces").getElementsByTagName("span")[0];
var BUTTON_END_GAME = document.getElementById("endGameButton");
var BUTTON_NEW_GAME = document.getElementById("newGameButton");
var CHECKBOX_TRAINEE_MODE = document.getElementById("traineeRadioCheckBox");
var BOX_END_GAME = document.getElementsByClassName("endGame")[0];
var MESSAGE_END_GAME = document.getElementById("winnerMessage").getElementsByTagName("span")[0];
var SPAN_TURN = document.getElementById("turnsCounter").getElementsByTagName("span")[0];
var LABEL_MINUTES = document.getElementById("minutes");
var LABEL_SECONDS = document.getElementById("seconds");
var h_SecondsGameTime;
var h_Interval; //========== Average ===========================================================

var LABEL_AVG_MINUTES = document.getElementById("avgMinutes");
var LABEL_AVG_SECONDS = document.getElementById("avgSeconds"); //=========== Total Average ====================================================

var LABAL_TOTAL_AVG_MINUTES = document.getElementById("totalAvgMinutes");
var LABEL_TOTAL_AVG_SECONDS = document.getElementById("totalAvgSeconds");
var h_TotalSecondsGameTime = 0;
var h_TotalTurnCount = 0;
var h_IntervalTotal;
var SPAN_JUST_TWO_BLACK_LEFT_COUNTER = document.getElementById("justTwoBlack").getElementsByTagName("span")[0];
var SPAN_JUST_TWO_WHITE_LEFT_COUNTER = document.getElementById("justTwoWhite").getElementsByTagName("span")[0];
var BOARD_DIMENSION = 10;
var PLAYER1_SYMBOL = 1;
var PLAYER2_SYMBOL = 2;
var TIE_SYMBOL = 0;
var MARKED_CELL_SYMBOL = "v";
var EMPTY_CELL_SYMBOL = 0;
var PLAYER1_COLOR = "black";
var PLAYER2_COLOR = "white";
var CLICKABLE_COLOR = "green";
var UNCLICKABLE_COLOR = "lightseagreen";
var h_CurrentPlayer;
...
var h_JustTwoBlack;
var h_JustTwoWhite;
var UP_MAIN_DIAGONAL = getAdjacentCellIDDirectionByDirectionIndecies(-1, -1);
var UP_COLUMN = getAdjacentCellIDDirectionByDirectionIndecies(-1, 0);
var UP_SECONDARY_DIAGONAL = getAdjacentCellIDDirectionByDirectionIndecies(-1, 1);
var LEFT_ROW = getAdjacentCellIDDirectionByDirectionIndecies(0, -1);
var RIGHT_ROW = getAdjacentCellIDDirectionByDirectionIndecies(0, 1);
var DOWN_SECONDARY_DIAGONAL = getAdjacentCellIDDirectionByDirectionIndecies(1, -1);
var DOWN_COLUMN = getAdjacentCellIDDirectionByDirectionIndecies(1, 0);
var DOWN_MAIN_DIAGONAL = getAdjacentCellIDDirectionByDirectionIndecies(1, 1);
startGame(); //=====================================
...
function initializeGameInfo() {
  ...
  H2_Now_PLAYING.innerText = "Player ".concat(h_CurrentPlayer, " - ").concat(getCurrentColor());
...
function updateAvailableMoves(i_LastMove) {
  if (!checkIfSideLeftColumn(i_LastMove)) {
    //i_LastMove % 10 != 0
  ...
  if (!checkIfSideRightColumn(i_LastMove)) {
    //i_LastMove % 10 != 9
...
function getAffectedCellsArray(i_LastMove) {
  var checkEdgeFunctionForRow = function checkEdgeFunctionForRow(i) {
  ...
  var checkEdgeFunction = function checkEdgeFunction(i) {
...
function getAdjacentCellIDDirectionByDirectionIndecies(i_X, i_Y) {
  ...
  if (i_X == 0) {
    ...
    //decend main or secondary diagonals
